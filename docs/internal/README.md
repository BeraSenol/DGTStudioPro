...
- **DECISIONS.md** — the append-only decision log. Every numbered decision (D-numbers, sequential, never reused) with its full argument and the rejected alternatives. Superseded entries stay in place, struck where overturned. This file owns the next free D-number.
